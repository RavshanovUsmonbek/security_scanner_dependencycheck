const dependencycheckIntegration = {
    delimiters: ['[[', ']]'],
    components: {
...
>
    ...
    methods: {
        ...
        handleEdit(data) {
            console.debug('dependencycheck editIntegration', data)
                ...
                response.json().then(
                    errorData => {
                        errorData.forEach(item => {
                            console.debug('dependencycheck item error', item)
        ...
        initialState: () => ({
            ...
            pluginName: 'security_scanner_dependencycheck',
...
register_component('dependencycheckIntegration', dependencycheckIntegration)
